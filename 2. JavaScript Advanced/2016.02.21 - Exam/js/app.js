...
(function (eventSystem) {
	//TODO: Dynamicaly add options to select HTML tag: motherflippin check all over that
    var select = document.getElementById('halls');
    var counter = 1;
    app.halls.forEach(function(h) {
        select.options[counter] = new Option(h.getName());
        counter++;
    });
