namespace Orders
{
    ...
    public class DataMapper
    {
        ...
        public IEnumerable<string> Get5MostExpensiveProducts()
        {
            var mostExpensive5Products = this.GetAllProducts()
            .OrderByDescending(p => p.UnitPrice)
            .Take(5)
            .Select(p => p.Name);

            return mostExpensive5Products;
        }
