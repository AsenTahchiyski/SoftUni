namespace HotelBookingSystem.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IView Register(string username, string password, string confirmPassword, string role)
        {
            ...
            {
                throw new ArgumentException("The provided passwords do not match."); // BUG: wrong message, "do not" added
            }
        ...
        {
            // PERFORMANCE: bottleneck, we should just check if current user != null
